...
import { PLANTASONIC_V2_SEED_BUNDLE } from './presetBundles.js';

/** Plantasonic app plugins — creative extensions registered through platform PluginManager */
export const PLANTASONIC_V2_PLUGINS: PlatformPlugin[] = [
  {
    manifest: {
      id: 'plantasonic-v2.seed-preset',
    ...
    register(context) {
      context.registerPresetBundle(PLANTASONIC_V2_SEED_BUNDLE);
    },
  },
  {
    manifest: {
      id: 'plantasonic-v2.visual',
