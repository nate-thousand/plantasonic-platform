 ...
 */
export const PLANTASONIC_V2_PRESET_BUNDLES: PresetBundle[] = [
  {
    id: 'root',
    name: 'Root',
...
/** Seed bundle — default Plantasonic starter session */
export const PLANTASONIC_V2_SEED_BUNDLE: PresetBundle = {
  id: 'seed',
  name: 'Seed',
...
export const PLANTASONIC_V2_STARTER_BUNDLE = PLANTASONIC_V2_SEED_BUNDLE;
